...
const JordyKlein = () => {
    ...
    return (
        ...
        <div className='jordy-klein'>
            ...
            <p>
            Jordan "Jordy" Klein Jr. is a legendary aerial and aquatic cinematographer, and owner of Jordan Klein Film & Video and Xcam Aerials Inc. Jordy has worked for years alongside his Academy Award-Winning D/P and father, Jordan Klein Sr. Jordy has shot numerous movies, commercials, documentaries, and industrial films for clients such as CSI Miami, One Tree Hill, HBO, Netflix, Sea World, Sea-Doo Watercraft, Discovery Channel, and most Hollywood studios. Jordy is an accomplished R/C, and drone pilot and holds a part 107 drone license. Jordy is also a commercial full-sized helicopter and fixed-wing pilot. Additionally, Jordy is an accomplished Steadicam operator and Underwater cinematographer and holds an advanced mixed-gas scuba license.
            </p>
            </Animated>
            </div>
        </div>
